    ...
    <div class="modal-card">
      ...
      <div class="second">
        <div
          v-if="tableaddMode"
          class="sensorInfo"
          style="padding-top: 40px; max-height: 85%; overflow-y: auto"
        >
          <p class="layer-tit">테이블 생성</p>
          <div class="attrTab">
            <span style="width: 40%; float: left">테이블 이름</span>
            <VInput style="width: 60%; float: right" type="text" />
          </div>

          <div class="attrTab">
            <span style="width: 40%; float: left">수용 인원</span>
            <VInput style="width: 60%; float: right" type="text" />
          </div>
                  ...
                  <div v-if="oneSen.SENSOR_EVENT_ID === 3">
                    <div>
                      <select
                        ...
                        @change="
                          eventChange($event, oneSen.SENSOR_EVENT_REL_ID)
                        "
                        style="width: 70%"
                      >
                        <option
...
export default {
  ...
  methods: {
    ...
    onMapClick(e) {
      ...
      let idx = this.tables.length
      console.log(idx)
      this.tables[idx] = L.marker(e.latlng, {
        icon: this.targetIcons.VIOLET_ICON,
        key: -idx,
        visible: true,
        draggable: true,
        name: 'new ' + idx,
